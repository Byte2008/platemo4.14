classdef Block_HHO < BLOCK
% Complete HHO (Harris Hawks Optimization) block
...
%--------------------------------------------------------------------------
    ...
    methods
        ...
        function Main(obj, Problem, Precursors, Ratio)
            ...
            % Find the best solution (Rabbit/prey)
                    ...
                    elseif Sp < 0.5 && abs(Escaping_Energy) >= 0.5
                        ...
                        if FitnessSingle(Temp1) < FitnessSingle(Population(i))
                            ...
                            X2 = Rabbit.dec - Escaping_Energy * abs(Jump_strength * Rabbit.dec - PopDec(i,:)) + ...
                                 rand(1,D) .* LevyFlight(D, obj.beta);
